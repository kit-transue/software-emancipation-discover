========================================================================
		OLE Control DLL : CATEGORIESCOMBO
========================================================================

ControlWizard has created this project for your CATEGORIESCOMBO OLE Control DLL,
...
that make up your CATEGORIESCOMBO OLE Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
CategoriesCombo control:

CategoriesComboCtl.h
	This file contains the declaration of the CCategoriesComboCtrl C++ class.

CategoriesComboCtl.cpp
	This file contains the implementation of the CCategoriesComboCtrl C++ class.

CategoriesComboPpg.h
	This file contains the declaration of the CCategoriesComboPropPage C++ class.

CategoriesComboPpg.cpp
	This file contains the implementation of the CCategoriesComboPropPage C++ class.

CategoriesComboCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CCategoriesComboCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file CategoriesCombo.rc.
