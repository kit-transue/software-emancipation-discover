========================================================================
		ActiveX Control DLL : REPORTTEMOLATE
========================================================================

ControlWizard has created this project for your REPORTTEMOLATE ActiveX Control
...
that make up your REPORTTEMOLATE ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
ReportTemolate control:

ReportTemolateCtl.h
	This file contains the declaration of the CReportTemolateCtrl C++ class.

ReportTemolateCtl.cpp
	This file contains the implementation of the CReportTemolateCtrl C++ class.

ReportTemolatePpg.h
	This file contains the declaration of the CReportTemolatePropPage C++ class.

ReportTemolatePpg.cpp
	This file contains the implementation of the CReportTemolatePropPage C++ class.

ReportTemolateCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CReportTemolateCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file ReportTemolate.rc.
