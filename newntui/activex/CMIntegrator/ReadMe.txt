========================================================================
		ActiveX Control DLL : CMINTEGRATOR
========================================================================

ControlWizard has created this project for your CMINTEGRATOR ActiveX Control
...
that make up your CMINTEGRATOR ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
CMIntegrator control:

CMIntegratorCtl.h
	This file contains the declaration of the CCMIntegratorCtrl C++ class.

CMIntegratorCtl.cpp
	This file contains the implementation of the CCMIntegratorCtrl C++ class.

CMIntegratorPpg.h
	This file contains the declaration of the CCMIntegratorPropPage C++ class.

CMIntegratorPpg.cpp
	This file contains the implementation of the CCMIntegratorPropPage C++ class.

CMIntegratorCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CCMIntegratorCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file CMIntegrator.rc.
