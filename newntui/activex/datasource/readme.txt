========================================================================
		OLE Control DLL : DATASOURCE
========================================================================

ControlWizard has created this project for your DATASOURCE OLE Control DLL,
...
that make up your DATASOURCE OLE Control DLL.
...
DataSourceCtl.h
	This file contains the declaration of the CDataSourceCtrl C++ class.

DataSourceCtl.cpp
	This file contains the implementation of the CDataSourceCtrl C++ class.

DataSourcePpg.h
	This file contains the declaration of the CDataSourcePropPage C++ class.

DataSourcePpg.cpp
	This file contains the implementation of the CDataSourcePropPage C++ class.

DataSourceCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CDataSourceCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file DataSource.rc.
