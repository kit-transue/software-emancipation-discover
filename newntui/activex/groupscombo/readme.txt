========================================================================
		OLE Control DLL : GROUPSCOMBO
========================================================================

ControlWizard has created this project for your GROUPSCOMBO OLE Control DLL,
...
that make up your GROUPSCOMBO OLE Control DLL.
...
GroupsComboCtl.h
	This file contains the declaration of the CGroupsComboCtrl C++ class.

GroupsComboCtl.cpp
	This file contains the implementation of the CGroupsComboCtrl C++ class.

GroupsComboPpg.h
	This file contains the declaration of the CGroupsComboPropPage C++ class.

GroupsComboPpg.cpp
	This file contains the implementation of the CGroupsComboPropPage C++ class.

GroupsComboCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CGroupsComboCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file GroupsCombo.rc.
