========================================================================
		OLE Control DLL : QUERIESCOMBO
========================================================================

ControlWizard has created this project for your QUERIESCOMBO OLE Control DLL,
...
that make up your QUERIESCOMBO OLE Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
QueriesCombo control:

QueriesComboCtl.h
	This file contains the declaration of the CQueriesComboCtrl C++ class.

QueriesComboCtl.cpp
	This file contains the implementation of the CQueriesComboCtrl C++ class.

QueriesComboPpg.h
	This file contains the declaration of the CQueriesComboPropPage C++ class.

QueriesComboPpg.cpp
	This file contains the implementation of the CQueriesComboPropPage C++ class.

QueriesComboCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CQueriesComboCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file QueriesCombo.rc.
