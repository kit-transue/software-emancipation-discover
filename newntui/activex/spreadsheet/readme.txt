========================================================================
		ActiveX Control DLL : SPREADSHEET
========================================================================

ControlWizard has created this project for your SPREADSHEET ActiveX Control
...
that make up your SPREADSHEET ActiveX Control DLL.
...
SpreadsheetCtl.h
	This file contains the declaration of the CSpreadsheetCtrl C++ class.

SpreadsheetCtl.cpp
	This file contains the implementation of the CSpreadsheetCtrl C++ class.

SpreadsheetPpg.h
	This file contains the declaration of the CSpreadsheetPropPage C++ class.

SpreadsheetPpg.cpp
	This file contains the implementation of the CSpreadsheetPropPage C++ class.

SpreadsheetCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CSpreadsheetCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file Spreadsheet.rc.
