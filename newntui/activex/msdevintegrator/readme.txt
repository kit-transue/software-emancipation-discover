========================================================================
		ActiveX Control DLL : MSDEVINTEGRATOR
========================================================================

ControlWizard has created this project for your MSDEVINTEGRATOR ActiveX Control
...
that make up your MSDEVINTEGRATOR ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
MSDEVIntegrator control:

MSDEVIntegratorCtl.h
	This file contains the declaration of the CMSDEVIntegratorCtrl C++ class.

MSDEVIntegratorCtl.cpp
	This file contains the implementation of the CMSDEVIntegratorCtrl C++ class.

MSDEVIntegratorPpg.h
	This file contains the declaration of the CMSDEVIntegratorPropPage C++ class.

MSDEVIntegratorPpg.cpp
	This file contains the implementation of the CMSDEVIntegratorPropPage C++ class.

MSDEVIntegratorCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CMSDEVIntegratorCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file MSDEVIntegrator.rc.
