========================================================================
		ActiveX Control DLL : IMPACT
========================================================================

ControlWizard has created this project for your IMPACT ActiveX Control
...
that make up your IMPACT ActiveX Control DLL.
...
ImpactCtl.h
	This file contains the declaration of the CImpactCtrl C++ class.

ImpactCtl.cpp
	This file contains the implementation of the CImpactCtrl C++ class.

ImpactPpg.h
	This file contains the declaration of the CImpactPropPage C++ class.

ImpactPpg.cpp
	This file contains the implementation of the CImpactPropPage C++ class.

ImpactCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CImpactCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file Impact.rc.
