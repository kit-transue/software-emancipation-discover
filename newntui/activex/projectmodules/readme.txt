========================================================================
		OLE Control DLL : PROJECTMODULES
========================================================================

ControlWizard has created this project for your PROJECTMODULES OLE Control DLL,
...
that make up your PROJECTMODULES OLE Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
ProjectModules control:

ProjectModulesCtl.h
	This file contains the declaration of the CProjectModulesCtrl C++ class.

ProjectModulesCtl.cpp
	This file contains the implementation of the CProjectModulesCtrl C++ class.

ProjectModulesPpg.h
	This file contains the declaration of the CProjectModulesPropPage C++ class.

ProjectModulesPpg.cpp
	This file contains the implementation of the CProjectModulesPropPage C++ class.

ProjectModulesCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CProjectModulesCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file ProjectModules.rc.
