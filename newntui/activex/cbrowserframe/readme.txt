========================================================================
		OLE Control DLL : CBROWSERFRAME
========================================================================

ControlWizard has created this project for your CBROWSERFRAME OLE Control DLL,
...
that make up your CBROWSERFRAME OLE Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
CBrowserFrame control:

CBrowserFrameCtl.h
	This file contains the declaration of the CCBrowserFrameCtrl C++ class.

CBrowserFrameCtl.cpp
	This file contains the implementation of the CCBrowserFrameCtrl C++ class.

CBrowserFramePpg.h
	This file contains the declaration of the CCBrowserFramePropPage C++ class.

CBrowserFramePpg.cpp
	This file contains the implementation of the CCBrowserFramePropPage C++ class.

CBrowserFrameCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CCBrowserFrameCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file CBrowserFrame.rc.
